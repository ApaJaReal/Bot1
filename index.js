const  XBOT = 'ApaJa Bot'; // Nama Bot Whatsapp
const instagram = 'ERROR'; // Nama Instagramlu cok
const nomer = 'https://wa.me/6281328063545'; // Nomor whatsapplu cok
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281328063545:+62 813-2806-3545\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Owner ApaJaBot wa.me/6281328063545 ,MessageType.text);
}
else if (text == 'affis'){
conn.sendMessage(id, 'Aku BOT nya ApaJa' ,MessageType.text);
}
else if (text == 'audio'){
